...
# flink-sql-parquet JAR must be in jars/ (baked into Dockerfile)
ls jars/flink-sql-parquet-1.20.3.jar || \
  curl -fsSL -o jars/flink-sql-parquet-1.20.3.jar \
  "https://repo1.maven.org/maven2/org/apache/flink/flink-sql-parquet/1.20.3/flink-sql-parquet-1.20.3.jar"
```
